// Lokale Version des Klassenarbeitsplaners (ohne Firebase)
// Diese Version funktioniert nur mit LocalStorage
...
class KlassenarbeitsPlaner {
    constructor() {
        ...
        console.log('Klassenarbeitsplaner (Lokale Version) initialisiert');
        this.init();
    }
    ...
    init() {
        ...
        setTimeout(() => {
            this.showNotification('Klassenarbeitsplaner erfolgreich gestartet!', 'success');
        }, 500);
        
        console.log('Lokale App erfolgreich initialisiert');
    }
    ...
    updateConnectionStatus(status) {
        ...
        if (!statusElement || !textElement) {
            console.log('Status-Elemente noch nicht verfügbar');
            return;
        }
        ...
        console.log('Verbindungsstatus auf Bereit gesetzt');
    }
    ...
    saveExams() {
        try {
            ...
            this.showNotification('Fehler beim Speichern. Bitte versuchen Sie es erneut.', 'error');
        }
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Starte Klassenarbeitsplaner (Lokale Version)...');
    
    // Warte kurz damit alle DOM-Elemente verfügbar sind
    setTimeout(() => {
